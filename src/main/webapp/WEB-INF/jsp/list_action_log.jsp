...
<!DOCTYPE html>
<html>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jquery_min_2_1_4.js"></script>
...
<header class="am-topbar am-topbar-fixed-top">
    <div class="am-topbar-left am-hide-sm-only">
        <a href="ssm/mvc/home" class="logo"><span>Go<span>Home</span></span><i
    ...
    <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            ...
            <ul class="am-list admin-sidebar-list">
                <li><a href="ssm/mvc/home"><span class="am-icon-home"></span> 首页</a></li>
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="am-g">
                ...
                <div class="am-u-md-8">
                    <div class="card-box">
                        <h4 class="header-title m-t-0 m-b-30">最新记录</h4>
