        ...
        <div class="web_login">
            <form name="form2" id="regUser" accept-charset="utf-8" action=""
                ...
                <ul class="reg_form" id="reg-ul">
                    ...
                    <li>
                        <label for="phoneNumber" class="input-tips2">手机号：</label>

                        <div class="inputOuter2">

                            <input type="text" id="phoneNumber" name="cellNumber" maxlength="18" class="inputstyle2"/>
                        </div>
